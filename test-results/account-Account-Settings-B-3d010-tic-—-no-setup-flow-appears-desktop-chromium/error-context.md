...
- Name: account.spec.ts >> Account / Settings >> BUG: 2FA toggle is purely cosmetic — no setup flow appears
- Location: tests/e2e/account.spec.ts:31:7
...
Call log:
  - waiting for getByRole('switch', { name: /Two-factor authentication/ })
    - locator resolved to <button type="button" role="switch" aria-checked="false" aria-label="Two-factor authentication" class="relative inline-flex h-6 w-11 shrink-0 rounded-full transition-colors">…</button>
  ...
  - dialog [ref=e255]:
    - generic [ref=e257]:
      ...
      - generic [ref=e268]:
        - generic [ref=e269]:
          - img [ref=e271]
          - textbox "Email address" [active] [ref=e273]
        - generic [ref=e274]:
          - img [ref=e276]
