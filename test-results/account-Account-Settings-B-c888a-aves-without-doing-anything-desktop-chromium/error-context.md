...
- Name: account.spec.ts >> Account / Settings >> BUG: Change password 'saves' without doing anything
- Location: tests/e2e/account.spec.ts:21:7
...
Call log:
  - waiting for getByRole('button', { name: /^Change password$/ })
    - locator resolved to <button type="submit" class="btn-primary">Change password</button>
              ...
              - generic [ref=e157]:
                - generic [ref=e158]:
                  - generic [ref=e159]:
                    ...
                    - textbox "Current password" [ref=e162]: currentpw
                  - generic [ref=e163]:
                    - generic [ref=e164]: New password
                    - textbox "New password" [active] [ref=e166]: newpw1!
