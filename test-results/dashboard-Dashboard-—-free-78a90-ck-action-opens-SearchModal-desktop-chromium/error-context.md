...
- Name: dashboard.spec.ts >> Dashboard — free user >> 'Search stocks' quick action opens SearchModal
...
Call log:
  - waiting for getByRole('button', { name: /^Search stocks$/ }).first()
    - locator resolved to <button type="button" class="btn-primary mt-5 justify-center">…</button>
    ...
    - generic [ref=e4]:
      ...
      - generic [ref=e18]:
        ...
        - generic [ref=e28]:
          ...
          - button "ع" [ref=e30]
        - button "My account" [ref=e32]: F
  - main [ref=e33]:
    - generic [ref=e34]:
      - generic [ref=e36]:
        - generic [ref=e39]: Dashboard
        - heading "Welcome back, Free Person" [level=1] [ref=e42]
