...
- Name: account.spec.ts >> Account / Settings >> premium user can open Invoices modal showing 3 mock invoices
- Location: tests/e2e/account.spec.ts:50:7
...
Call log:
  - waiting for getByRole('button', { name: /^View invoices$/ })
    - locator resolved to <button type="button" class="btn-ghost justify-center">View invoices</button>
