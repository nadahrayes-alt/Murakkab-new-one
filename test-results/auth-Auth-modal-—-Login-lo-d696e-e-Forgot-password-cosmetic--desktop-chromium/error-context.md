...
- Name: auth.spec.ts >> Auth modal — Login >> login form has Remember me + Forgot password (cosmetic)
- Location: tests/e2e/auth.spec.ts:71:7

# Error details

```
Error: Forgot password link href
...
- generic [ref=e1]:
  ...
  - dialog [ref=e773]:
    - generic [ref=e775]:
      ...
      - img [ref=e781]
      - generic [ref=e783]:
        - heading "Log in" [level=2] [ref=e784]
        - paragraph [ref=e785]: Sign in to access your account and continue your analysis.
      - generic [ref=e786]:
        - generic [ref=e787]:
          - img [ref=e789]
          - textbox "Email address" [active] [ref=e791]
        - generic [ref=e792]:
          - img [ref=e794]
          - textbox "Password" [ref=e797]
          - button "Toggle password visibility" [ref=e799]:
            - img [ref=e800]
        - generic [ref=e803]:
          - generic [ref=e804] [cursor=pointer]:
            - checkbox "Remember me" [ref=e805]
            - text: Remember me
          - link "Forgot password?" [ref=e806] [cursor=pointer]:
            - /url: "#"
        - button "Log in" [ref=e807]
      - generic [ref=e810]: or
      - generic [ref=e812]:
        - button "Log in with Google" [ref=e813]:
          - img [ref=e814]
          - generic [ref=e819]: Log in with Google
        - button "Log in with Apple coming soon" [disabled] [ref=e820]:
          - img [ref=e821]
          - generic [ref=e823]: Log in with Apple
          - generic [ref=e824]: coming soon
      - generic [ref=e825]:
        - text: Don't have an account?
        - button "Sign up" [ref=e826]
```
